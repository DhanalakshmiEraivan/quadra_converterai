          ...
          <div className="lg:col-span-2">
            ...
            <div className="mt-5 flex items-center gap-2">
              {[Twitter, Linkedin, Github, Mail].map((Icon, i) => (
                <button key={i} className="grid h-9 w-9 place-items-center rounded-lg bg-white text-ink-500 ring-1 ring-ink-200 transition hover:text-brand-600 hover:ring-brand-200">
